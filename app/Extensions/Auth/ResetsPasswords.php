...
trait ResetsPasswords
{
    ...
    public function resetByPhone(Request $request)
    {
        ...
        return $response == Password::PASSWORD_RESET
                    ...
                    : $this->sendResetFailedResponseForPhone($request, $response);
    }
    ...
    {
        return $request->only(
            'email', 'password', 'password_confirmation', 'token', 'phone'
        );
    }
     ...
     * @return \Illuminate\Http\RedirectResponse|\Illuminate\Http\JsonResponse
     */
    protected function sendResetFailedResponseForPhone(Request $request, $response)
    {
