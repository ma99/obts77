        ...
        <add-section :show.sync="show">
          ...
          <div class="card">
            <div class="card-body bg-lightyellow">
              ...
              <div class="form-row justify-content-center py-3 my-3">
                <!-- <div class="col-sm-2"></div>   -->
                <div class="col-sm-5 px-4 py-3 bg-skyblue rounded-xlg shadow">
            ...
            <div class="card-footer text-center">
              <div class="button-group">
                <button v-on:click.prevent="save()" class="btn btn-primary mr-2" :disabled="!isValid">Save</button>
                  ...
                  <table class="table table-striped table-hover">
                      ...
                      <tbody>
                        <tr  v-for="(route, index) in availableRouteList">                              
                          ...
                          <td>
                              <button v-on:click.prevent="remove(route)" class="btn btn-outline-danger">
