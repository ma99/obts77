      ...
      <section class="content">
        ...
        <!-- <div class="container-fluid"> -->
          <!-- <div class="row"> -->
                  ...
                  <form>
                    <div class="form-row">                          
                      <div class="form-group col-6">
                        ...
                        <select 
                          id="user"
                          v-model="supervisor.selectedUserId" 
                        ...
                        > 
                            ...
                            <option 
                              ...
                              :value="user.id"        
                              v-text="user.name"
                              :disabled="isUserAvailableInSupervisorList(user)"
                              v-if="!optionByPhone"
                            >
                            </option>
                            <option 
                      ...
                      <div class="form-group col-sm-6">
                        ...
                        <input id="inputNid" v-model="supervisor.nid" type="number" class="form-control" :class="{ 'is-invalid': has('nid') }">
                      ...
                      <div class="form-group col-12">
                        ...
                        <input type="text" class="form-control" id="inputAddress" placeholder="Write address here" v-model="supervisor.address">
                      </div>
                      <div class="col-12">
            ...
            <div class="row justify-content-center my-3 p-2" v-if="availableSupervisorList.length > 0">
              <div class="card w-100">            
                <div class="card-body p-0">
                  ...
                  <table class="table table-striped table-hover">
                      ...
                      <tbody>
                        <tr  v-for="(supervisor, index) in availableSupervisorList">                              
                          <td>{{ index+1 }}</td>                              
                          ...
                          <td>
                            <div v-for="(image, index) in supervisor.images">
                          ...
                          <td>                           
                            <div>                                
                              <button @click.prevent="remove(supervisor)" class="btn btn-outline-danger">
            ...
            <!-- {{-- card-footer --}} -->
                <div class="card-footer">
                  <h5 class="px-1" v-if="availableSupervisorList.length > 1"> 
                    {{ availableSupervisorList.length }} 
                    <small class="text-muted"> supervisors available.</small>
                  </h5>                                   
                  <h5 class="px-1" v-else> 
                    {{ availableSupervisorList.length }} 
                    <small class="text-muted"> supervisor available.</small>
                  </h5>                                   
                </div>
              </div>
            </div>
...
<script>
    ...
    export default {
        ...
        async mounted() {
            ...
            await this.getSupervisors({token: this.token});

            console.log('Supervisor Component mounted.')
            this.loading = false;
        ...
        watch: {
          ...
          deleted(value) {
            if( value === true ) {
              ...
              this.responseMessage = 'Supervisor Deleted Successfully.';
        ...
        computed: {
          ...
          isValid() {
            return this.supervisor.selectedUserId != '' &&          
                   this.supervisor.nid != '' &&
                   this.supervisor.address != '';
          },          
        },
        ...
        methods: {
            ...
            isUserAvailableInSupervisorList(user) {
              const found = this.availableSupervisorList.find(element => element.user_id === user.id);
            ...
            remove(supervisor) { 
              ...
              swal({
                title: "Are you sure?",
                text: `${supervisor.name} will be Removed!`,
                icon: "error",                 
                dangerMode: true,
                buttons: {
                    cancel: "cancel",
              ...
              .then(async (value) => {
                if (value) {
                  ...
                  vm.loading = true;
                  vm.showAlert = false;
                  await vm.deleteSupervisor({supervisor: supervisor});
                }                   
              }); 
            },
            reset() { 
