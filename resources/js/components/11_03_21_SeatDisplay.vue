<template>
  <div>
    <!-- Progress Tracker -->
      <div class="progressbar mx-auto my-5">
        <ul class="text-center">
          <li>
            ...
            <!-- <div class="mt-3 mb-1 mx-auto action">               -->
              <i class="fas fa-check my-3 action first done"></i>            
            <!-- </div> -->
            <p>Search</p>
          </li>
          <li>
            ...
            <!-- <span class="mt-3 mb-1 mx-auto action">               -->
              <i class="fas fa-sync my-3 action doing"></i>            
            <!-- </span> -->
            <p>Select</p>
          </li>
          <li>
            ...
            <!-- <span class="mt-3 mb-1 mx-auto action">               -->
              <i class="fas fa-times my-3 action last"></i>            
            <!-- </span> -->
            <p>Buy</p>
          </li>
        </ul>
