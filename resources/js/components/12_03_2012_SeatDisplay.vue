<template>
  <div>
    <!-- Progress Tracker -->
      <div class="row no-gutters progressbar mx-auto my-3 text-center">
        <!-- <ul class="text-center"> -->
          <div class="col-4 position-relative">
            <div class="shape-outer rhombus">
              <i class="fas fa-search fa-3x progress-icon"></i>
            </div>
            
            <!-- <div class="mt-3 mb-1 mx-auto action">               -->
              <!-- <i class="fas fa-check my-3 action first done" -->
              <i                
                :class="['fas',                    
                  { 'fa-times': steps.search.default },
                  { 'fa-sync': steps.search.isDoing },
                  { 'fa-check': steps.search.isDone }, 
                  { doing: steps.search.isDoing },
                  { done: steps.search.isDone },
                  'my-3', 'action', 'first'
                ]"                
              ></i>            
            <!-- </div> -->
          ...
          <div class="col-4 position-relative">
            <div class="shape-outer rhombus">
              <i class="fas fa-hand-pointer fa-3x progress-icon"></i>            
            </div>
            <!-- :class="{ doing: steps.select.isDoing }"
            :class="{ done: steps.select.isDone }" -->
            <!-- <span class="mt-3 mb-1 mx-auto action">               -->
              <!-- <i class="fas fa-sync my-3 action doing" -->
              <i 
                :class="['fas',                    
                  { 'fa-times': steps.select.default },
                  { 'fa-sync': steps.select.isDoing },
                  { 'fa-check': steps.select.isDone }, 
                  { doing: steps.select.isDoing },
                  { done: steps.select.isDone },
                  'my-3', 'action'
                ]"                
              ></i>            
            <!-- </span> -->
          ...
          <div class="col-4 position-relative">
            <div class="shape-outer rhombus">
              <i class="fas fa-wallet fa-3x progress-icon"></i>            
            </div>                
            <i 
              :class="['fas',                    
                { 'fa-times': steps.buy.default },
                { 'fa-sync': steps.buy.isDoing },
                { 'fa-check': steps.buy.isDone }, 
                { doing: steps.buy.isDoing },
                { done: steps.buy.isDone },
                'my-3', 'action', 'last'
              ]"                
            ></i>            
            <!-- </span> -->
