              ...
              <div v-if="vm.showSchedule && !vm.searchMini" class="bg-lightlemonyellow rounded">
                ...
                <div class="row mx-0 my-2">
                  ...
                  <div class="col-md-4">
                    ...
                    {{-- BUS ICON --}}
                      <div class="px-2 bg-bus mx-auto" :style="vm.styles">
                      </div>
                  </div>

                  {{-- <div class="col-md-5 px-md-0 my-sm-3 my-md-auto"> --}}
                  <div class="col-md-5 px-md-0 my-3 my-md-auto">
                    {{-- DATE NAVIGATION --}}
                  ...
                  {{-- <div class="col-md-3 mx-auto mb-3 my-md-auto"> --}}
                  <div class="col-md-3 mb-3 my-md-auto">
                     {{-- SEARCH AGAIN BTN --}}
                      {{-- <div class="px-2"> --}}
                        <button type="button" @click.prevent="vm.handleSearchMini()" class="px-4 btn btn-warning form-control mb-sm-1 rounded-pill">
